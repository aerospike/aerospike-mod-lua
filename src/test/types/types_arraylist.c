...
TEST( types_arraylist_cap10_blk0, "as_arraylist w/ capacity 10, block_size 0" ) {
    ...
    assert_int_eq( l.u.arraylist.block_size, 0 );
    assert_int_eq( l.u.arraylist.size, 0 );
...
TEST( types_arraylist_cap10_blk10, "as_arraylist w/ capacity 10, block_size 10" ) {
    ...
    assert_int_eq( l.u.arraylist.capacity, 10 );
    assert_int_eq( l.u.arraylist.block_size, 10 );
    assert_int_eq( l.u.arraylist.size, 0 );
    ...
    assert_int_eq( rc, AS_ARRAYLIST_OK );
    assert( l.u.arraylist.size == as_list_size(&l) );
    assert_int_eq( l.u.arraylist.size, 11);
