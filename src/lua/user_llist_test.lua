-- Example User Module for Large List (llist)
-- This instance just calls the Test Package (for objects)

local ldt_settings=require('settings_llist');
...
local exports = {}
  ...
  function exports.adjust_settings( ldtMap )
    ...
    ldt_settings.use_package( ldtMap, "TestModeObject" );
